...
if (hours < 6) {
    greeting.textContent = 'Good Night! You should probably be sleeping... welcome to the portfolio of Adam Argam.';
} else if (hours < 12) {
    greeting.textContent = 'Good Morning! Welcome to the portfolio of Adam Argam.';
} else if (hours < 18) {
    greeting.textContent = 'Good Afternoon! Explore Adam Argam\'s projects.';
} else {
    greeting.textContent = 'Good Evening! Discover some amazing work by Adam Argam.';
}
...
const tools = [
    ...
    { name: "Unreal", icon: "unrealengine", experience: "0.5 years", useGh: false },
